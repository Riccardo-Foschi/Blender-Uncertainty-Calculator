...
[Download the Grasshopper algorithm for model proofing from here! (click on VIEW RAW)](https://github.com/Riccardo-Foschi/Blender-Uncertainty-Calculator/blob/main/MODEL_PROOF_100.gh)
