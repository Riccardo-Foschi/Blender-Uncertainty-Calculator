...
-----> [Download the Blender plugin (Beta) from here!](https://github.com/Riccardo-Foschi/Blender-Uncertainty-Calculator/releases/download/v5.0.1/AU_VR_501.zip) <-----
...
Download Grasshopper algorithms for Rhinoceros here (right click -> "save link as" to download):
...
- [Rhino test scene with simple geometries with mistakes to fix](https://github.com/Riccardo-Foschi/Blender-Uncertainty-Calculator/blob/main/Profing%20Models.3dm)
